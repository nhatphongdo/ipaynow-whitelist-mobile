        ...
        return (
            <AnimatedSvg height={this.props.height} width={this.props.width}>
                <Svg.Defs>
                    {this.props.animated && (
                        <Svg.LinearGradient id="grad" x1={this.props.x1} y1={this.props.y1} x2={this.props.x2} y2={this.props.y2}>
                            <Svg.Stop offset={this.state.offsets[0]} stopColor={this.props.primaryColor} stopOpacity="1" />
                            <Svg.Stop offset={this.state.offsets[1]} stopColor={this.props.secondaryColor} stopOpacity="1" />
                            <Svg.Stop offset={this.state.offsets[2]} stopColor={this.props.primaryColor} stopOpacity="1" />
                        </Svg.LinearGradient>
                    )}
                ...
                <Svg.Rect
                    ...
                    fill={this.props.animated ? "url(#grad)" : this.props.primaryColor}
                    clipPath="url(#clip)"
                />
            </AnimatedSvg>
        );
