...
import { REWARD, HDN } from "../../stores/rates/constants";
  ...
  onConfirm = async () => {
    ...
    this.props.showAlert({
      ...
      message: translate("Do you really want to buy {0} Reward with {1} Ruby?", [
        formatReward(convertRateSync(this.props.rates.rates, HDN, REWARD, this.state.selectedOption * this.props.settings.buyRewardRatio)),
  ...
  send = async address => {
    ...
    await this.props.updateTransaction(
      ...
      `${translate("Buy")} ${formatReward(
        convertRateSync(this.props.rates.rates, HDN, REWARD, this.state.selectedOption * this.props.settings.buyRewardRatio)
      )} ${translate("REWARD")}`,
      BUY_REWARD,
              ...
              <View smallSpaceTop style={styles.list}>
                {this.props.settings.buyRewardOptions.map((item, index) => (
                  ...
                  >
                    ...
                    >
                      {formatCurrency(item, this.props.settings.culture, HDN)}
                    </StyledText>
                    <StyledText
                      tinySpaceBottom
                    ...
                    >
                      {formatCurrency(
                        convertRateSync(this.props.rates.rates, HDN, REWARD, item * this.props.settings.buyRewardRatio),
