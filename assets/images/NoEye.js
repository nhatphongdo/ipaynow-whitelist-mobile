    ...
    <Svg width={52 * ratio} height={48 * ratio} {...others}>
      ...
      <G fill="none" fillRule="evenodd" filter="url(#prefix__a)" transform="translate(-180 -97)" scale={ratio}>
        <G transform="translate(205 114.243)">
          <Path fill="#186BFE" d="M7.182.874A16.351 16.351 0 018.75 2.757S5.17 8.007.875 8.007c-.272 0-.535-.012-.79-.035L7.181.874z" />
        </G>
        <Path
          fill="#186BFE"
        ...
        <G transform="translate(199.75 110.743)">
          <Path fill="#186BFE" fillOpacity={0.3} d="M.087 11.887L11.844.132l1.237 1.237L1.325 13.125z" />
        </G>
      </G>
    </Svg>
  );
