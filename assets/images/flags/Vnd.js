    ...
    return (
        <Svg width={256 * ratio} height={256 * ratio} {...others}>
            ...
            <G clipPath="url(#prefix__a)" scale={ratio}>
                <Path fill="#da251d" d="M-57 0h384v256H-57z" />
                <Path
                    d="M73.134 106.643l33.9 24.627-12.951 39.849 33.9-24.627 33.9 24.627-12.954-39.849 33.9-24.627h-42.04L127.98 67.222l-12.808 39.421z"
                    fill="#ff0"
                />
            </G>
