...
export default {
  ...
  primaryButtonBackground: props => <LinearGradient colors={["#186bfe", "#186bfe"]} start={[1.113, 0.591]} end={[-0.062, 0.676]} {...props} />,
  secondaryButtonBackground: props => <LinearGradient colors={["#186bfe", "#186bfe"]} start={[1.113, 0.591]} end={[-0.062, 0.676]} {...props} />,
  thirdaryButtonBackground: props => <LinearGradient colors={["#ffffff", "#ffffff"]} start={[1.113, 0.591]} end={[-0.062, 0.676]} {...props} />,
  tinyButtonBackground: props => <LinearGradient colors={["#186bfe", "#186bfe"]} start={[1.113, 0.591]} end={[-0.062, 0.676]} {...props} />,
  disabledButtonBackground: props => <LinearGradient colors={["#cadbfb", "#cadbfb"]} start={[1.113, 0.591]} end={[-0.062, 0.676]} {...props} />,
  badgeBackground: props => <LinearGradient colors={["#186bfe", "#186bfe"]} start={[1, 1]} end={[0, 0]} {...props} />,
  primaryBackground: props => <LinearGradient colors={["#186bfe", "#186bfe"]} start={[1, 0.46]} end={[0, 0.456]} {...props} />,
  groupBoxHeaderBackground: props => <LinearGradient colors={["#186bfe", "#186bfe"]} start={[0.5, 0]} end={[0.5, 1]} {...props} />,
  ...
  lock: props => <Lock colors={["#186bfe", "#186bfe"]} start={["50%", "0%"]} end={["50%", "100%"]} {...props} />,
  ...
  faceId: props => <FaceId colors={["#186bfe", "#186bfe"]} start={["50%", "0%"]} end={["50%", "100%"]} {...props} />,
  touchId: props => <TouchId colors={["#186bfe", "#186bfe"]} start={["50%", "0%"]} end={["50%", "100%"]} stroke="#186bfe" {...props} />,
  ...
  homeIcon: props => <HomeIconDark fill="#186BFE" {...props} />,
  qrBox: props => <QrBox colors={["#15bdd8", "#15bdd8"]} start={["50%", "0%"]} end={["50%", "100%"]} {...props} />,
  qrLabel: props => <QrLabel colors={["#186BFE", "#186BFE"]} start={["50%", "0%"]} end={["50%", "100%"]} fill="#fff" {...props} />,
  ...
  luckyDrawMachine: props => (
    <LuckyDrawMachine
      colors={["#186BFE", "#186BFE"]}
      start={["50%", "0%"]}
      end={["50%", "100%"]}
      colors2={["#186BFE", "#186BFE"]}
      start2={["50%", "0%"]}
      end2={["50%", "100%"]}
      {...props}
    />
  ...
  dropdownIcon: props => <DropdownIcon fill="#186bfe" {...props} />,
  starIcon: props => <StarIcon colors={["#186bfe", "#186bfe"]} start={["50%", "0%"]} end={["50%", "100%"]} fill="url(#prefix__a)" {...props} />,
  heartIcon: props => (
    <HeartIcon colors={["#186bfe", "#186bfe"]} start={["50%", "0%"]} end={["50%", "100%"]} stroke="#186bfe" fill="url(#prefix__a)" {...props} />
  ),
  directionIcon: props => <DirectionIcon fill="#ba1c2a" stroke="#ba1c2a" {...props} />,
  filterIcon: props => <FilterIcon stroke="#fff" {...props} />,
  exchangeIcon: props => <ExchangeIcon fill="#186BFE" {...props} />,
  exchangeMoneyIcon: props => <ExchangeMoneyIcon colors={["#186bfe", "#186bfe"]} start={["50%", "0%"]} end={["50%", "100%"]} {...props} />,
  ...
  historyIcon: props => <HistoryIcon fill="#186BFE" {...props} />,
  arrowUp: props => <ArrowUp fill="#191660" {...props} />,
  arrowDown: props => <ArrowDown fill="#191660" {...props} />,
  profileIcon: props => <ProfileIcon fill="#186BFE" {...props} />,
  mallIcon: props => <MallIcon fill="#186BFE" {...props} />,
  deleteIcon: props => <DeleteIcon stroke="#186BFE" {...props} />,
